...
import com.learnSpringSecurityJVL.LearnSpringSecurityJVL.security.JwtFilter;
...
//        ).build(); // allow all request
        ...
        http.authorizeHttpRequests(auth ->
                auth
                        .requestMatchers(HttpMethod.POST, "/api/users").permitAll() // allow post method alone
